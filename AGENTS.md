...
VS Code extension for a Markdown live-preview editing editor. TypeScript + CodeMirror 6 + esbuild + VS Code API.
...
- ユーザーのMarkdown本文は書き換えない。装飾は表示だけに適用する。
...
- 過去経緯（必要時のみ）: `docs/ai/development-history.md`
