...
> ▶️ **開発継続中（2026-06-26 時点 / v1.20.0）**: v1.11.0 の開発凍結は v1.12.0 で解除済み。v1.20.0 では、Live Preview をソース横の編集可能な WebviewPanel ビューアへ変更し、アクティブエディタ追従と複数文書ビューアを追加した（R-03）。改めて凍結する場合は本バナーを凍結表記に戻し、凍結理由（品質安定・スコープ確定）を踏まえて判断すること。
