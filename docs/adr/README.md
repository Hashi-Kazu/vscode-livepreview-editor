...
| [0005](0005-custom-text-editor-provider.md) | CustomTextEditorProvider の採用 | WebviewPanel でなく CustomTextEditorProvider で TextDocument 管理を VS Code に委譲 | 高 |
...
| [0012](0012-single-tab-editor-switch.md) | ビュー切り替えの単一タブ保持方式 | openWith 後に stale タブを close して「同一タブ切り替え」に見せる。API 制約への対処 **(要確認)** | 高 |
